...
Every response returns a JSON object with label, severity, log, and attack-specific fields. The SSE stream at /vuln/stream also broadcasts every event in real time if you want to monitor all activity live.
